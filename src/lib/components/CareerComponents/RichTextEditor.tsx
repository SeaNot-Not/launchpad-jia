...
export default function RichTextEditor({ setText, text, isError = false }) {
  ...
  return (
    <div style={{ outline: isError ? "2px solid #FDA29B" : "none", borderRadius: "0.375rem" }}>
      <div
      ...
      >
        <button type="button" className="btn btn-sm btn-outline-secondary" onClick={() => formatText("bold")} title="Bold" style={{ padding: "4px 8px", fontSize: 20, color: "#535862" }}>
          <i className="la la-bold"></i>
        </button>
        <button type="button" className="btn btn-sm btn-outline-secondary" onClick={() => formatText("italic")} title="Italic" style={{ padding: "4px 8px", fontSize: 20, color: "#535862" }}>
          <i className="la la-italic"></i>
        </button>
        <button type="button" className="btn btn-sm btn-outline-secondary" onClick={() => formatText("underline")} title="Underline" style={{ padding: "4px 8px", fontSize: 20, color: "#535862" }}>
